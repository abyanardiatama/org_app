...
use App\Filament\Resources\SuratProposalResource\Pages;
use App\Filament\Resources\SuratProposalResource\RelationManagers;

class SuratProposalResource extends Resource
{
    protected static ?string $model = SuratProposal::class;
    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';
    protected static ?string $label = 'Surat Proposal';
            ...
            ->schema([
                ...
                Section::make()->schema([
                    Forms\Components\TextInput::make('nama_kegiatan')
                        ->label('Nama Kegiatan')
                        ->required(),
                    Forms\Components\DateTimePicker::make('hari_tanggal_waktu')
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('nama_kegiatan')
                    ->label('Nama Kegiatan')
                    ->searchable(),
                Tables\Columns\TextColumn::make('hari_tanggal_waktu')
                    ->label('Hari, Tanggal & Waktu')
                    ->dateTime('d-m-Y H:i')
                    ->sortable(),
            ...
            ->actions([
                \Filament\Tables\Actions\Action::make('Download')
                    ...
                    ->action(function ($record) {
                        $templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor(public_path('template/template_proposal.docx'));
                        ...
                        $templateProcessor->setValue('hari_tanggal_waktu', \Carbon\Carbon::parse($record->hari_tanggal_waktu)->translatedFormat('l, d F Y'));
                        $templateProcessor->setValue('waktu', \Carbon\Carbon::parse($record->hari_tanggal_waktu)->translatedFormat('H:i'));
                        ...
                        $fileName = "Surat Proposal - {$record->nama_kegiatan} - {$cleanNoSurat}";
                        $docxPath = public_path("storage/surat_proposal/{$fileName}.docx");
                        ...
                        if ((int)$record->jml_lampiran === 0) {
                            ...
                            $zipPath = public_path("storage/surat_proposal/{$zipFileName}");
                            $zip = new \ZipArchive();
    ...
    {
        return [
            'index' => Pages\ListSuratProposals::route('/'),
            'create' => Pages\CreateSuratProposal::route('/create'),
            'edit' => Pages\EditSuratProposal::route('/{record}/edit'),
        ];
    }

    public static function getEloquentQuery(): \Illuminate\Database\Eloquent\Builder
    {
        return SuratProposal::query()
